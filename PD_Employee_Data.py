...
#Avg monthly income per total working years (sorted by highest income to lowest)
...
#Avg salary hike per Education field (sorted by highest income to lowest)
